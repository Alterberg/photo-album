    ...
    public partial class InitialCreate : DbMigration
    {
        public override void Up()
        {
            CreateTable(
                ...
                .ForeignKey("dbo.Photos", t => t.PictureId, cascadeDelete: true)
                .Index(t => t.AuthorId)
                .Index(t => t.PictureId);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Photos", "AuthorId", "dbo.UserProfiles");
            DropForeignKey("dbo.Marks", "PictureId", "dbo.Photos");
            DropForeignKey("dbo.Marks", "AuthorId", "dbo.UserProfiles");
            ...
            DropIndex("dbo.Marks", new[] { "AuthorId" });
